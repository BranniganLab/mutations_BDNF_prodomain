...
def write_periodic_image_frames_to_list():
    """
    This function reads a mindist.xvg generated by the GROMACS mindist command. If the mindist value is less than max_distance, it appends the associated time frame to a list.
