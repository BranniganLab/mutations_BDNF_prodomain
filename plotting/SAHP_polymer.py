...
if __name__ == "__main__":
    ...
    my_blob_dict = {}
    my_blob_dict['p1'] = [list(range(23,31)), 15.60864769334838, 6.5512217244393725]
    my_blob_dict['h1a'] = [list(range(31,39)), 15.285062476838306, 6.527842794695208]
    my_blob_dict['s1'] = [list(range(39,42)), 8.017528391753814, 3.576432187851238]
    my_blob_dict['h1b'] = [list(range(42,48)), 11.397579985992893, 5.202326024411827]
    my_blob_dict['p2'] = [list(range(48,55)), 13.872995967507851, 6.184960950726784]
    my_blob_dict['h2a'] = [list(range(55,64)), 14.596836565919011, 6.633933315233838]
    my_blob_dict['s2'] = [[64,65], 5.46005549094433, 3.6268007517942498]
    my_blob_dict['h2b'] = [list(range(66,73)), 16.193394891759624, 6.039168002143983]
    my_blob_dict['p3'] = [list(range(73,88)), 22.76445509534148, 9.866056332905446]
    my_blob_dict['h3a'] = [list(range(88,92)), 9.013628622889852, 4.543846469052056]
    my_blob_dict['s3'] = [[92], 3.3640498377884955, 1.7401193892282825]
    my_blob_dict['h3b'] = [list(range(93,98)), 12.863326340581743, 5.53480023476145]
    my_blob_dict['s4'] = [[98], 3.4166062996729285, 1.737190753551981]
    my_blob_dict['h3c'] = [list(range(99,104)), 13.154235668499851, 5.640484909176506]
    my_blob_dict['s5'] = [[104], 2.855973120179598, 1.7378962471059733]
    my_blob_dict['h3d'] = [list(range(105,112)), 15.874499711660318, 6.167675449002173]
    my_blob_dict['s6'] = [[112,113], 5.728855451480986, 4.013912539508555]    
